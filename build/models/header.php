	...
	<header>
		<nav class=" container flex items-center py-4 mt-4 sm:mt-12">
			...
			<ul class="hidden md:flex flex-1 justify-end items-center gap-12 text-gray-700 uppercase text-xs">
				<li class="cursor-pointer"> <?php if ($_SESSION["role"] == 1 || $_SESSION["role"] == 2) {   ?> <a href="article.php?new=1"> <button class=" shadow-red-500/50 shadow-lg rounded-md px-7 transition duration-300 py-3 uppercase bg-red-500 text-white hover:bg-red-200 ">Create article</button></a> <?php } ?> </li>

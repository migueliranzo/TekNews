...
<?php
    ...
    case 6:
      ...
      ?>
        ...
        <div class="grid lg:pt-12 auto-cols-max m-0 bg-white  lg:grid-cols-3 gap-x-5 gap-y-6  grid-cols-2  sm:grid-cols-2 lg:m-0 sm:m-8 md:m-16">
        <a href="article.php?article= <?php echo $row["id"] ?> ">
        <div class="  flex flex-col xl:text-lg   duration-200 group cursor-pointer border-gray-400 border-solid border-b border-r rounded-b-2xl rounded-l-none hover:border-blue-800
    news-card-effect after:ease-out after:h-[66%] after:hover:h-[62%]">
          <div class="overflow-hidden">
            <div class="flex flex-1  transform group-hover:scale-110 ease-out  duration-300">
              <img src=' <?php echo $row["imgpath"]; ?> ' alt="">
            </div>
              ...
              <?php
                ...
                case 12:
                  ...
                  <a href="article.php?article= <?php echo $row["id"] ?>" class=" container mt-6  flex flex-col duration-200 overflow-hidden group cursor-pointer border-l-4 rounded-l-2xl lg:rounded-l-none 
                      lg:border-l-0 border-r-4 border-t-4 border-b-4 rounded-r-2xl border-dotted  border-blue-600 col-span-2 lg:col-span-3 sm:col-span-2 sm:row-span-1 row-span-1 lg:row-span-2" >
                        ...
                        <div class="overflow-hidden  my-4">
                          <div class="flex flex-1 justify-center pb-1   duration-300 ease-out">
                            ...
                            <div class="flex-1">
                              <article class="overflow-hidden text-ellipsis prose " style="display: -webkit-box; -webkit-line-clamp: 10; line-clamp: 10;  -webkit-box-orient: vertical;"> 
